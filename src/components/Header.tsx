...
const navItems = [
  ...
  { label: "ANUDOA", href: "/anudoa" },
  {
    ...
    href: "/ranking",
    children: [
      { label: "UI Green Metric 2022", href: "/ranking#green-metric-2022" },
      { label: "Green University Award 2021", href: "/ranking#green-award-2021" },
      { label: "UI Green Metric 2021", href: "/ranking#green-metric-2021" },
      { label: "NAAC Accreditation", href: "/ranking#naac" },
      { label: "NIRF Ranking", href: "/ranking#nirf" },
      { label: "NBA Accreditation", href: "/ranking#nba" },
      { label: "ISO Certification", href: "/ranking#iso" },
      { label: "ARIIA Ranking", href: "/ranking#ariia" },
    ],
  },
